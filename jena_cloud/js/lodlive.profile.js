var s4 = {							// новый s4
	url : "http://education-sw.appspot.com/Servlet",
	"ontology-folder" : "http://vt.obninsk.ru/s/",
	"ontology-prefix" : "http://vt.obninsk.ru/s/",
	lang : "ru",
	dbpedia : "dbpedia",
	dataType : "text",
	...
	implicit : "education-sw"
};

var dict = {
	"education-sw" : {"name":"Семантический веб"},
...
$.jStorage.set('profile', {
	'connection' : {
			'education-sw' : {
			description : {
				ru : 'Образовательный портал «Кафедра онлайн». Учебный курс «Семантическая веб»',
				en : "Образовательный портал «Кафедра онлайн». Учебный курс «Семантическая веб»",
				title : "Semantic Web в примерах"
			},
			endpoint : "https://rdf.s4.ontotext.com/4931580652/education/repositories/education-ksst",
			sparql : {
			...
			examples : [
			{uri : 'Department_of_Intellectual_Cybernetic_Systems', label : 'Институт'}, 
			{uri : 'Semantic_Web', label : 'Семантический веб'},
			{uri : 'Training_Course',	label : 'Учебный курс'}, 
			{uri : 'Victor_Telnov', label : 'Преподаватель'},
			{uri : 'Graph_Database', label : 'Лекция'}, 
			{uri : 'Video._Ontologies', label : 'Видео'},
			{uri : 'Liyang_Yu_2014', label : 'Учебник'}, 
			{uri : 'Graphs_of_knowledge_based_on_the_Cloud_Cabinet', label : 'Проектное задание'}, 
			{uri : 'W3C_Semantic_Web', label : 'Стандарт'}, 
			{uri : 'Requirements_for_the_content_and_execution_of_the_final_project_report', label : 'Требование'}, 
			{uri : 'Examination_tickets', label : 'Экзаменационные билеты'}, 
			{uri : 'SWeb_Syllabus', label : 'Рабочая программа дисциплины'}
			]
		},
		'http://dbpedia.org' : {
			description : {
	...
	'default' : {
		...
		images : {
			properties : ['http://vt.obninsk.ru/s/#image', 'http://www.w3.org/2006/vcard/ns#photo', 'http://xmlns.com/foaf/0.1/depiction', 'http://dbpedia.org/ontology/thumbnail', 'http://dbpedia.org/property/logo', 'http://linkedgeodata.org/ontology/schemaIcon']
		},
		videos : {
			properties : ['http://vt.obninsk.ru/s/#video']
		},
		keywords : {
			properties : ['http://vt.obninsk.ru/s/#keywords']
		},
		maps : {
